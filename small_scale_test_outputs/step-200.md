# Test Outputs - step 200

Test Metrics
  - STEP: 200
  - TOTAL_AVAILABLE_TEST_ROWS: 6
  - SELECTED_TEST_ROWS: 6
  - POSTPROCESSED_TURN_STOP_RATE: 0.9775
  - PROTOCOL_VALID_RATE: 0.9775
  - RAW_TURN_STOP_RATE: 1.0000
  - RECORD_COUNT: 6
  - SRC_RELEASE_ACCURACY: 0.9733
  - SRC_RELEASE_TOTAL: 75
  - SRC_WAIT_ACCURACY: 0.8571
  - SRC_WAIT_TOTAL: 14
  - TGT_RELEASE_ACCURACY: 0.8500
  - TGT_RELEASE_TOTAL: 20
  - TGT_WAIT_ACCURACY: 0.8841
  - TGT_WAIT_TOTAL: 69
  - TURN_COUNT: 89
...
3. <src><|wait|></src><tgt>This is the survey</tgt>  -  <src>データになります。</src><tgt><|wait|></tgt>
4. <src>データになります。</src><tgt><|wait|></tgt>  -  <src>データになります。</src><tgt><|wait|></tgt>
5. <src><|wait|></src><tgt><|wait|></tgt>  -  <src><|wait|></src><tgt><|wait|></tgt>
6. <src>こういったデータであったり、</src><tgt>data. You can see data like this—</tgt>  -  <src>こういったデータであったり、</src><tgt><|wait|></tgt>
7. <src><|wait|></src><tgt><|wait|></tgt>  -  <src><|wait|></src><tgt><|wait|></tgt>
8. <src>これは</src><tgt><|wait|></tgt>  -  <src>これは</src><tgt><|wait|></tgt>
9. <src>奈良県の</src><tgt>this one, for example,</tgt>  -  <src>奈良県の</src><tgt>these are from Nara Prefecture,</tgt>
...
8. <src>that file, </src><tgt>그 안에 담긴 내용이나</tgt>  -  <src>that file, </src><tgt>그 안의 내용을</tgt>
...
4. <src><|wait|></src><tgt><|wait|></tgt>  -  <src><|wait|></src><tgt>마찬가지로 돈과 관련해서도</tgt>
5. <src>我们从这里呢可以</src><tgt><|wait|></tgt>  -  <src>我们从这里呢可以</src><tgt>양 पहलू에 있어서도 주의해야 할 점은</tgt>
6. <src>看到的是</src><tgt>마찬가지로 금전적인 부분에서 주의할 점인데,</tgt>  -  <src>看到的是</src><tgt>양쪽 모두에게 공통된 점은 돈을 조심해야 한다는 것입니다. 여기서 볼 수 있는 점은</tgt>
...
12. <src>通常它</src><tgt>이 카드는 손을 의미합니다. 손은</tgt>  -  <src>通常它</src><tgt>이 카드는 '손'을 상징합니다.</tgt>
13. <src>非常的</src><tgt><|wait|></tgt>  -  <src>非常的</src><tgt><|wait|></tgt>
14. <src>直白，代表是</src><tgt><|wait|></tgt>  -  <src>时白代表是</src><tgt><|wait|></tgt>
...
18. <src>不要，</src><tgt>아주 직설적인 카드라 돈과 관련해</tgt>  -  <src>不要，</src><tgt>매우 직설적이고,</tgt>
...
24. <src>的男性</src><tgt>너무 많은 계획을 세우지 않는 게 좋다는 뜻인데요,</tgt>  -  <src>的男性</src><tgt>지나 지도 좀 하는데요,</tgt>
...
5. <src>加密资产企业家孙宇晨</src><tgt>On March 22nd, the U.S. Securities and Exchange Commission</tgt>  -  <src>加密资产企业家孙宇晨</src><tgt>On March 22nd, the U.S. Securities and Exchange Commission announced that crypto entrepreneur</tgt>
6. <src>及其三家</src><tgt><|wait|></tgt>  -  <src>及其三家</src><tgt><|wait|></tgt>
7. <src>全资公司</src><tgt><|wait|></tgt>  -  <src>知名公司，</src><tgt><|wait|></tgt>
8. <src>提起诉讼，</src><tgt><|wait|></tgt>  -  <src>提起诉讼，</src><tgt><|wait|></tgt>
9. <src>指控他们没有经过注册</src><tgt><|wait|></tgt>  -  <src>指控他们没有经过注册</src><tgt>filed a lawsuit against crypto entrepreneur and three}$
10. <src>提供和出售</src><tgt>announced a lawsuit against crypto entrepreneur Justin Sun and three of his companies, alleging that they offered and sold</tgt>  -  <src>提供和出售</src><tgt>announced the SEC is suing crypto entrepreneur and its three}$
...
1. <src><|wait|></src><tgt><|wait|></tgt>  -  <src>启示录</src><tgt><|wait|></tgt>
2. <src>启示录和</src><tgt>『ヨハネの黙示録』と</tgt>  -  <src>启示录和</src><tgt>『開祖記』と</tgt>
3. <src>翡翠石板</src><tgt><|wait|></tgt>  -  <src>肥岁时班</src><tgt><|wait|></tgt>
4. <src>都曾经预测到，</src><tgt>『エメラルド・タブレット』のどちらもが予言していたことがあります。</tgt>  -  <src>都曾经预测到，</src><tgt>水晶の青石板が予言した内容は、</tgt>
5. <src>这十四万四千名</src><tgt><|wait|></tgt>  -  <src>这十四万四千名</src><tgt><|wait|></tgt>
6. <src>光之工作者</src><tgt>それは、14万4000人のライトワーカーが</tgt>  -  <src>光十字工作者</src><tgt>14万4000人の光の十字架伝道者が</tgt>
7. <src>的到来，会</src><tgt><|wait|></tgt>  -  <src>的状态到达，会</src><tgt><|wait|></tgt>
8. <src>在卡利年代</src><tgt>到来し、カリ・ユガの</tgt>  -  <src>会卡瓦利年代</src><tgt>到来すると</tgt>
9. <src>结束时，</src><tgt><|wait|></tgt>  -  <src>结束时，</src><tgt><|wait|></tgt>
10. <src>将地球</src><tgt>終わりに地球を</tgt>  -  <src>将地球</src><tgt>終焉を迎えるとき、</tgt>
...
5. <src>矿物质，更多的</src><tgt>우리 몸은 뼈 속의 미네랄을 소모하게 되고, 더 많은</tgt>  -  <src>矿物质，更多的</src><tgt>우리 몸에서 칼슘을 소모하게 됩니다. 뼈에 있는 미네랄 도는데, 그러니까</tgt>
6. <src>靠物矿物质。</src><tgt><|wait|></tgt>  -  <src>靠物、</src><tgt><|wait|></tgt>
7. <src><|wait|></src><tgt><|wait|></tgt>  -  <src><|wait|></src><tgt><|wait|></tgt>
8. <src>所以呢，</src><tgt><|wait|></tgt>  -  <src>所以呢，</src><tgt>부원소인 칼슘이나 마그네슘 같은 것들이 빠져나가게 됩니다.</tgt>
9. <src>这个肥胖人</src><tgt><|wait|></tgt>  -  <src>这个肥胖人</src><tgt>줄기성 비만 환자의 경우니까요,</tgt>
10. <src>往往都会有</src><tgt>미네랄을 필요로 하게 됩니다. 그래서 비만인 분들은</tgt>  -  <src>往往</src><tgt>사람들이 살이 찌면 반드시</tgt>
...
14. <src>的问题，就是</src><tgt><|wait|></tgt>  -  <src>的就是</src><tgt>관절이나 연부 조직에 질환이 생기기 쉽거든요.</tgt>
15. <src>因为什么？</src><tgt>관절이나 연조직 문제를 자주 겪는데요. 왜 그럴까요?</tgt>  -  <src>因为什么？</src><tgt>관절이나 연부 조직 질환이 흔한데, 이게 뭐 때문일까요?</tgt>
