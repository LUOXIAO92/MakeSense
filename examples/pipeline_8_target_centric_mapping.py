...
INPUT_CACHE_BASE = CACHE_ROOT / "pipeline_7_pure_text_segmentation_deepseek-v4-flash"
OUTPUT_BASE      = CACHE_ROOT / "pipeline_8_target_centric_mapping_deepseek-v4-flash"
